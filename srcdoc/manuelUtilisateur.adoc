...
Une fois la documentation générée, vous la trouverez par défaut sur la branche "doc_release", dans le répertoire "doc_release" si aucun problème n'a été détecté ou dans le répertoire "doc_failure" sinon +
